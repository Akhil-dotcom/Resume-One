...
const [addInfo, setaddInfo] = useState<boolean>(false);
  return (
    <div className="sm:bg-gray-800 sm:p-5 rounded-md mx-auto font-raedex">
        {/* personal Info */}
        <div className="text-xl text-white font-semibold pb-3">Personal Info</div>
        <div className="">
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="flex flex-col">
                    <label className="text-xs text-slate-400 pb-2">First Name</label>
                    <input className="border-2 rounded-md p-2 bg-gray-700 border-gray-400 outline-none focus:border-cyan-500 text-gray-300 text-sm" />
                </div>
                <div className="flex flex-col">
